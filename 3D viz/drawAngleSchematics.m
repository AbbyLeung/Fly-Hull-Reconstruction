% -------------------------------------------------------------------------
% script to generate 3D fly models that can be used to illustrate body and
...
figPosition = [1, 41, 1920, 963] ; %[1921, 41, 1920, 963]
       ...
       if labelFlag
        ...
        if labelFlag
            ...
            AHatLabel = text(AHatTip(1), AHatTip(2), AHatTip(3), ...
                xyzBodyLabels{1}, 'FontName',fontName,'FontSize',fontSize,...
