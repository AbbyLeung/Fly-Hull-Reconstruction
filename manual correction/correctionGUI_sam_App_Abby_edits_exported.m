classdef correctionGUI_sam_App_Abby_edits_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function handles = loadData(app, hObject, handles)
            ...
            if ~isempty(handles.datapath_curr)
                ...
                % detect bad frames automatically on load
    ...
    methods (Access = private)
        ...
        % Button pushed function: phi_view, phi_view_2
        ...
        function save_data_Callback(app, event)
            [hObject, eventdata, handles] = convertToGUIDECallbackArguments(app, event); %#ok<ASGLU>
            % hObject    handle to ffwd (see GCBO)
            % eventdata  reserved - to be defined in a future version of MATLAB
            % handles    structure with handles and user data (see GUIDATA)
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.savedataButton = uibutton(app.figure1, 'push');
            app.savedataButton.ButtonPushedFcn = createCallbackFcn(app, @save_data_Callback, true);
